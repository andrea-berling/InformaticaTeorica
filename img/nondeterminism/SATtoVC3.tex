%% img/nondeterminism/SATtoVC3.tex
...
\begin{document}
    \begin{tikzpicture}[point/.style={draw,circle,inner sep=0cm,fill=black,minimum size=2pt}]
        ...
        \node[draw,shape=circle] () at (nA) {};
        \node[draw,shape=circle] () at (nB) {};
        \node[draw,shape=circle] () at (nC) {};
        \node[draw,shape=circle] () at (t1_1) {};
        \node[draw,shape=circle] () at (t1_3) {};
        \node[draw,shape=circle] () at (t2_2) {};
        \node[draw,shape=circle] () at (t2_3) {};
        \node[draw,shape=circle] () at (t3_2) {};
        \node[draw,shape=circle] () at (t3_3) {};
        \node[draw,shape=circle] () at (t4_1) {};
        \node[draw,shape=circle] () at (t4_2) {};

        \node () at (0,-6) {$v =
        \set{\pair{A}{\textit{false}},\pair{B}{\textit{false}},\pair{C}{\textit{false}}}$};
    \end{tikzpicture}
\end{document}
