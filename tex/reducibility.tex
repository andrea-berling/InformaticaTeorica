...
%    definito:
%    \begin{equation*}
%        B = \set{f(\phii(i)) \mid i \in \Nat}
%    \end{equation*}
%
%    Abbiamo che $B$ è sottoinsieme di $A$ e che $B$ è r.e. non ricorsivo. Infatti se $B$ fosse decidibile lo
%    sarebbe anche $K$. Infatti abbiamo che $i \in K \implies \phii(i) \converges \implies
%    f(\phii(i)) \in B$. Viceversa supponiamo che $i \notin K$ e che $f(\phii(i)) \in B$. Ma la
%    seconda ipotesi e' vera sse $\phi(i)\converges$, ovvero se $i \in K$. Ma questo e' assurdo.
%    Quindi $f(\phii(i)) \notin B$.
%\end{proof}
